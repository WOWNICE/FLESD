...
def main_worker(gpu, ngpus_per_node, args):
    ...
    num_classes = num_classes_mapping[args.dataset]
    ...
    # Data loading code
    train_dataset, val_dataset = get_eval_dataset(args)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    """
    ## finetune the model to check whether the training code is reliable.
    model.eval()
