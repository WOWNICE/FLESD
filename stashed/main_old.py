...
def main():
    ...
    if not args.pubset:
        ...
        pubset = inferset if not args.flesd_cl else get_dataset_ssl(args)[0]
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        # support client number < gpu number.
        ###########################################################
        manager = Manager()
        ...
        processes = [
            Process(target=global_update_ERD_CL if args.flesd_cl else global_update_ERD,
